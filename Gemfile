...
gem 'aws-sdk-s3', '>= 1.37.0', require: false
...
gem 'rack-protection' , '>= 2.0.8' # security
...
group :development do
  ...
  gem 'bullet', '>= 6.0.1', require: !!ENV['BULLET']
  ...
  if rails_master?
    gem 'annotate', '>= 3.0.0', '>= 3.0.0', git: 'https://github.com/ctran/annotate_models.git'
  else
    gem 'annotate'
  end
end
...
gem 'rack-mini-profiler', '>= 1.1.1', require: false
